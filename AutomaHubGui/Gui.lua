...
local Window = WindUI:CreateWindow({
    ...
    OpenButton = {
        ...
        StrokeThickness = 2,
        Enabled = true,          -- Re-enabled WindUI's built-in OpenButton
        Draggable = true,
        OnlyMobile = true,       -- Only visible on mobile/touch screens
        Scale = 0.5,
...
-- PC Keybind (Alt Kanan / RightAlt) to toggle GUI visibility
