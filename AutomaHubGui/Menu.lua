...
-- Aim Tab (Aim Veil Settings)
local VeilSection = AimTab:Section({ Title = "Aim Veil Settings" })
...
VeilSection:Slider({
    ...
    Callback = function(value: number)
        if Aim and Aim.SetVeilLeadMult then
            Aim.SetVeilLeadMult(value)
        end
    end
})
...
VeilSection:Slider({
    ...
    Callback = function(value: number)
        if Aim and Aim.SetVeilMinDist then
            Aim.SetVeilMinDist(value)
        end
    end
})
...
VeilSection:Slider({
    ...
    Callback = function(value: number)
        if Aim and Aim.SetVeilMaxDist then
            Aim.SetVeilMaxDist(value)
        end
    end
})
